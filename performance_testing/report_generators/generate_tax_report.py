...
def scan_reports():
    ...
    # Tax reports folders
    folders = ['../../tax_reports/tax_reports_10', '../../tax_reports/tax_reports_50', '../../tax_reports/tax_reports_100', '../../tax_reports/tax_reports_150', '../../tax_reports/tax_reports_200']
    ...
    for folder in folders:
        ...
        # Extract limit from folder name (tax_reports_10 -> 10)
...
<body>
    <div class="header">
        <h1>📊 Tax Query Performance Test - Combined Report</h1>
        <div class="subtitle">
            Tax-related queries across different result limits and search types<br>
...
def main():
    ...
    output_file = "../../tax_queries_report.html"
