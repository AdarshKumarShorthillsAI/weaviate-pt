"""
PARALLEL MIXED SEARCH via FastAPI - Locust performance testing

Usage:
    python fastapi_server.py  # Start server first
    locust -f locustfile_mixed_fastapi.py --users 100 --spawn-rate 5 --run-time 5m --headless
"""
...
def on_locust_init(environment, **kwargs):
    ...
    print("=" * 80)
    print("🚀 PARALLEL MIXED SEARCH TEST (via FastAPI)")
    print("=" * 80)
    try:
